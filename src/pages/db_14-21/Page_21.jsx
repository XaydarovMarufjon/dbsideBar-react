...
const Page_21 = () => {
  ...
  return (
    <>
      <div className='px-5'>
        <h4 className='text-center bg-mavzu py-2 mb-5'>КСПЕРТИЗА ИНФОРМАЦИОННЫХ СИСТЕМ НА СООТВЕТСТВИЕ ТРЕБОВАНИЯМ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ</h4>
        <form className="row">
          ...
          <div className="mb-3 col-6 col-lg-4">
            ...
            <select name="" id="" className="form-select">
              <option selected>Прямая ссылка на СБ "Основание для проверки "ЦКБ"</option>
            </select>
          </div>
          <div className="mb-3 col-6 col-lg-4">
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Источник информации об "ТП"</label>
            <select name="" id="" className="form-select">
