    ...
    <div className='px-5'>
      ...
      <form className="row">
        ...
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Организация предоставленная услуга "СЕРТИФИКАЦИЯ СМИБ"</label>
        ...
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Дата подписанного договора на проведение Сертификации СМИБ (поступивщего запроса)</label>
        ...
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Услуга "СЕРТИФИКАЦИЯ СМИБ" осуществлена подразделением ГУП "ЦКБ"</label>
          <select name="" id="" className="form-select">
            <option selected>Прямая и обратная ссылка на БД "Подразделение ГУП "Центр кибербезопасности"</option>
          </select>
        </div>
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Сотрудники Центра участвовавшие в Сертификации СМИБ</label>
          <select name="" id="" className="form-select">
            <option selected>Прямая и обратная ссылка на БД "Подразделение ГУП "Центр кибербезопасности"</option>
          </select>
        </div>
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Дата начала предоставления услуги "Сертификации СМИБ"</label>
          <input type="date" id="" className="form-select" />
        </div>
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Стадия реализации услуги (на какой стадии находится осуществление Сертификации СМИБ)  </label>
          <input type="text" id="" className="form-control" />
        </div>
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Первый этап сертификационного аудита</label>
          <select name="" id="" className="form-select ">
            <option>Прямая ссылка на СБ "1-этап СМИБ"</option>
          </select>
        </div>
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Второй этап сертификационного аудита</label>
          <select name="" id="" className="form-select ">
            <option>Прямая ссылка на СБ "2-этап СМИБ"</option>
          </select>
        </div> 
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Дата окончания предоставления услуги "Сертификации СМИБ"</label>
          <input type="date" id="" className="form-select" />
        </div>
        <div className="mb-3 col-6 col-lg-4">
        ...
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Итоговый документ по результатам реализации услуги "СЕРТИФИКАЦИЯ СМИБ" (ДОК файл на внешней папке)</label>
          <select name="" id="" className="form-select ">
            <option>Прямая ссылка на ДОК файл с данными по конкретной организации на внешнем источнике (папке)</option>
          </select>
        </div>
        <div className="mb-3 col-6 col-lg-4">
          <label className="form-label">Источник информации об "СУ"</label>
          <select name="" id="" className="form-select ">
