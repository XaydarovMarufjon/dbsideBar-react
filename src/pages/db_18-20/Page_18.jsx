...
const Page_18 = () => {
  ...
  return (
    <>
      <div className='px-5'>
        <h4 className='text-center bg-mavzu py-2 mb-5'>АУДИТ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ ОБЪЕКТОВ ИНФОРМАТИЗАЦИИ</h4>
        <form className="row">
         ...
         <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Прямая ссылка на ДОК файл с данными по конкретной организации на внешнем источнике (папке)</label>
            <select name="" id="" className="form-select ">
              <option>  Итоговый документ по результатам реализации услуги "АУДИТ ИБ ОИ" (ДОК файл на внешней папке)</option>
            </select>
          </div> 
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Прямая и обратная ссылка на БД "ИСТОЧНИК ИНФОРМАЦИИ"</label>
            <select name="" id="" className="form-select ">
              <option>Источник информации об "АБ"</option>
            </select>
          </div> 
