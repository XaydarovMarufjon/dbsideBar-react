...
const Page_4_1 = () => {
  return (
    <>
    <div className='px-5'>
    <h4 className='text-center bg-info py-2'>ЭКСПЕРТИЗА ВЕБ-САЙТОВ ДОМЕННОЙ ЗОНЫ "UZ" НА СООТВЕТСТВИЕ ТРЕБОВАНИЯМ КИБЕРБЕЗОПАСНОСТИ</h4>
    <form className="row">
          ...
          <div className="mb-3 col-6 col-lg-4">
              <label className="form-label">Выявленные угрозы</label>
              <input type="text" id="" className="form-control" />
          </div> 
          <div className="mb-3 col-6 col-lg-4">
              <label className="form-label">Выявленные недостатки</label>
              <input type="text" id="" className="form-control" />
          </div> 
          <div className="mb-3 col-6 col-lg-4">
              <label className="form-label">состояние продотвращения выявленных несоответствий</label>
              <input type="text" id="" className="form-control" />
          </div> 
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label"><b>Дата начала предоставления услуги "Экспертиза веб-сайтов"</b></label>
            <input type="date" name="" id=""  className='form-control'/>
          </div>
          <div className="mb-3 col-6 col-lg-4">
              <label className="form-label">Стадия реализации услуги (на какой стадии находится осуществление экспертизы) </label>
              <input type="text" id="" className="form-control" />
          </div> 
          <div className="mb-3 col-6 col-lg-4">
              <label className="form-label">Выявленные уязвимости</label>
              <input type="text" id="" className="form-control" />
          </div> 
          <div className="mb-3 col-6 col-lg-4">
              <label className="form-label">Выявленные угрозы</label>
...
{/* page 12 ===  <div className="mb-3 col-6 col-lg-4">
<label className="form-label">Основание проведения экспертизы</label>
<select name="" id="" className="form-select">
   <option>Праямая ссылка на СБ "Основание экспертизы"</option>
  </select>
</div>
<div className="mb-3 col-6 col-lg-4">
<label className="form-label">Наименование организации, запросивщая "Экспертизу веб-сайтов"</label>
 <select name="" id="" className="form-select">
  <option selected>Прямая  и обратная ссылки на БД "Органиизация"</option>
  </select>
</div> 
<div className="mb-3 col-6 col-lg-4">
  <label className="form-label">Основание для осуществления экспертизы</label>
  <input type="text" id="" className="form-control" />
</div> 
<div className="mb-3 col-6 col-lg-4">
  <label className="form-label">Номер подписанного договора, запроса и т.д.  на проведение экспертизы</label>
  <input type="text" id="" className="form-control" />
</div> 
<div className="mb-3 col-6 col-lg-4">
<label className="form-label">Дата подписанного договора на проведение экспертизы (поступивщего запроса)</label>
<input type="date" name="" id=""  className='form-control'/>
</div>
<div className="mb-3 col-6 col-lg-4">
  <label className="form-label">Сумма оплаты за услугу по договору</label>
...
<div className="mb-3 col-6 col-lg-4">
<label className="form-label">Предмет экспертизы (точное наименование услуги)</label>
  <select name="" id="" className="form-select">
    <option selected>Прямая ссылка на СБ "Предметы экспертизы"</option>
  </select>
</div> 
<div className="mb-3 col-6 col-lg-4">
<label className="form-label">Объект экспертизы (конкретные объекты экспертизы)</label>
  <select name="" id="" className="form-select">
    <option selected>Прямая ссылка на СБ "Предметы экспертизы"</option>
  </select>
</div> 
<div className="mb-3 col-6 col-lg-4">
<label className="form-label"><b>Услуга "Экспертиза веб-сайтов" осуществлена подразделением ГУП "ЦКБ"</b></label>
  <select name="" id="" className="form-select">
     <option selected>  Прямая ссылка на СБ "Виды экспертиз"</option>
  </select>
</div> 
<div className="mb-3 col-6 col-lg-4">
<label className="form-label"><b>Дата предыдущей эскпертизы</b></label>
<input type="date" name="" id=""  className='form-control'/>
</div>
<div className="mb-3 col-6 col-lg-4">
  <label className="form-label">Выявленные уязвимости</label>
