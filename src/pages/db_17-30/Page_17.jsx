      ...
      <div className='px-5'>
        ...
        <form className="row">
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Организация предоставленная услуга "Разработка политики ИБ"</label>
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Номер подписанного договора, запроса и т.д.  на проведение Разработка политики ИБ</label>
            <input type="text" id="" className="form-control" />
          </div>

          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Дата подписанного договора на проведение Разработка политики ИБ (поступивщего запроса)</label>
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Услуга "Разработка политики ИБ" осуществлена подразделением ГУП "ЦКБ"</label>
            <select name="" id="" className="form-select">
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Сотрудники Центра участвовавшие в Разработке политики ИБ</label>
            <select name="" id="" className="form-select">
              <option selected>Прямая и обратная ссылка на БД "Подразделение ГУП "Центр кибербезопасности"</option>
            </select>
          </div>
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Дата начала предоставления услуги "Разработка политики ИБ"</label>
            <input type="date" id="" className="form-select" />
          </div>

          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Стадия реализации услуги (на какой стадии находится осуществление Разработки политики ИБ)   </label>
            <input type="text" id="" className="form-control" />
          </div>

          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Проведение предварительного обследования состояния ИБ</label>
            <select name="" id="" className="form-select">
              <option selected>Прямая ссылка на СБ "1-этап Политики ИБ"</option>
            </select>
          </div>

          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Разработка политики ИБ</label>
            <select name="" id="" className="form-select">
              <option selected>Прямая ссылка на СБ "Разработка Политики ИБ"</option>
            </select>
          </div>

          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Дата окончания предоставления услуги "Разработка политики ИБ"</label>
            <input type="date" name="" id="" className='form-control' />
          </div>
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Итоговый документ по результатам реализации услуги "Разработка политики ИБ" (ДОК файл на внешней папке)</label>
            <select name="" id="" className="form-select">
          ...
          <div className="mb-3 col-6 col-lg-4">
            <label className="form-label">Источник информации об "РП"</label>
            <select name="" id="" className="form-select">
