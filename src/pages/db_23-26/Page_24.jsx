...
const Page_24 = () => {
  ...
  return (
    <>
      <div className='px-5'>
        <h4 className='text-center bg-mavzu py-2 mb-5'>С О Б Ы Т И Е  ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ</h4>
        <form className="row">
        ...
        <div className="mb-3 col-6 col-lg-4">
          ...
          <div className="mb-3 col-6 col-lg-4">
            ...
            <input type="text" id="" className="form-control" placeholder='конвертировать в словарь'/>
          </div>
